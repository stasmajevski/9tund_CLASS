		...
		<div class="row">
			<div class="col-sm-4 col-sm-offset-4">
				...
				<form method="POST">
					...
					<input type="submit" value="Logi sisse1" class="btn btn-success btn-block visible-xs-block">
					<input type="submit" value="Logi sisse2" class="btn btn-success btn-sm hidden-xs">
